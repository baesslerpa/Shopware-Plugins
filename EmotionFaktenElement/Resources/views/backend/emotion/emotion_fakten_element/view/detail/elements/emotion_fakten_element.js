...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.EmotionFaktenElement', {
     ...
     */
    alias: 'widget.detail-element-emotion-fakten-element',

    /**
     * You can define an additional CSS class which will be used for the grid element.
     */
    componentCls: 'emotion--fakten-element',
