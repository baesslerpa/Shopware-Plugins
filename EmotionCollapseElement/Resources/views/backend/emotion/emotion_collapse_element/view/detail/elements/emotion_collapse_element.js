...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.EmotionCollapseElement', {
     ...
     */
    alias: 'widget.detail-element-emotion-collapse-element',

    /**
     * You can define an additional CSS class which will be used for the grid element.
     */
    componentCls: 'emotion--collapse-element',
